...
const ExtractQuestions = () => {
  ...
  const handleExtractQuestions = async () => {
    ...
    try {
      ...
      setQuestions(response.data); // assuming it returns an array
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 to-purple-200 flex items-center justify-center p-6">
      ...
      >
        ...
        <p className="text-center text-gray-600 mb-6 max-w-xl mx-auto">
          Upload a PDF file and generate comprehension or quiz-style questions
          from its content. Perfect for educators, students, and content
          creators looking to automate question generation.
        </p>
